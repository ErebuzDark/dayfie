    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          {user ? (
            <>
              <button className="btn-primary" onClick={onNewPost} style={{ fontSize: '0.85rem', padding: '0.5rem 1.1rem' }}>
                <PlusOutlined />
                New Post
              </button>
            ...
            <button className="btn-primary" onClick={() => navigate('/login')} style={{ fontSize: '0.85rem', padding: '0.5rem 1.1rem' }}>
              <LoginOutlined />
              Sign In
            </button>
          )}
